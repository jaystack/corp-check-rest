...
const reduce = <R>(reducer: Reducer<R>, accResult: R, tree: Package, path: string[], depth: number): R => {
...
export default <R>(tree: Package, reducer: Reducer<R>, initialResult: R, depth: number = Infinity): R => {
